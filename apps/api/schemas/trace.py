...
class TraceResponse(BaseModel):
    ...
    answer_language: Optional[str] = Field(default="en", description="Answer language selected for response rendering.")
    answer_language_source: Optional[str] = Field(default="default", description="Source for answer language selection.")
    language_preservation_applied: Optional[bool] = Field(default=False, description="Whether localized response framing was applied.")
    language_preservation_status: Optional[str] = Field(default="english_default", description="Language preservation result status.")
    language_preservation_limitations: Optional[str] = Field(default="", description="Limitations note when fallback language rendering is used.")
    ...
    entity_answer_mode: Optional[str] = Field(default="", description="Entity answer mode selected by entity answer composer.")
    entity_answer_mode_source: Optional[str] = Field(default="", description="Source used to decide entity answer mode.")
    entity_profile_link_found: Optional[bool] = Field(default=None, description="Whether profile-link evidence was found.")
    entity_official_website_found: Optional[bool] = Field(default=None, description="Whether official website evidence was found.")
    entity_business_presence_supported: Optional[bool] = Field(default=None, description="Whether public online presence is supported by evidence.")
    entity_registry_evidence_found: Optional[bool] = Field(default=None, description="Whether registry/source-of-record evidence was found.")
    entity_legal_registration_verified: Optional[bool] = Field(default=None, description="Whether legal registration was verified from source-of-record evidence.")
    entity_answer_limitations: Optional[str] = Field(default=None, description="Limitations/uncertainty note for entity answer mode.")
